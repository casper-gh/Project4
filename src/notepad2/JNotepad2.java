...
public class JNotepad2 extends JPanel
{
	...
	public JNotepad2()
	{
    	...
    	class openL implements ActionListener
		{
			public void actionPerformed(ActionEvent e)
			{
				...
				int returnVal = fc.showDialog(JNotepad2.this, "Open file");
		...
		class saveL implements ActionListener
		{
			...
			{
				JFileChooser fc = new JFileChooser();
				int returnVal = fc.showSaveDialog(JNotepad2.this);
				if(returnVal == JFileChooser.APPROVE_OPTION)
				{
		...
		class pasteL implements ActionListener
		{
			public void actionPerformed(ActionEvent e)
			{
				Transferable clipData = clipbd.getContents(JNotepad2.this);
				try
				{
					String clipString =
  	...
  	{
   	JFrame f = new JFrame();
   	JNotepad2 applet = new JNotepad2();
   	f.setTitle("JNotepad");
